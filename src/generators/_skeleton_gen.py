"""SKELETON generator — copy to <lang>_gen.py and fill in the emit functions.

Each _emit_* function returns a string of source code for one AST node.
The helpers _type(), _expr(), _stmt() are already wired up; only language
syntax strings need changing.
"""
