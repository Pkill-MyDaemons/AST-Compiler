"""Parse Swift source → unified AST using tree-sitter-swift."""
...
# ---------------------------------------------------------------------------
try:
    import tree_sitter_swift as _ts_lang
...
_NODE_METHOD       = "function_declaration"
_NODE_CLASS        = "class_declaration"
_NODE_STRUCT       = "struct_declaration"
_NODE_INTERFACE    = "protocol_declaration"
_NODE_VAR          = "variable_declaration"
_NODE_CONST        = "constant_declaration"  # let

_STMT_RETURN       = "return_statement"
_STMT_IF           = "if_statement"
_STMT_WHILE        = "while_statement"
_STMT_FOR          = "for_in_statement"
_STMT_FOR_EACH     = "for_in_statement"
_STMT_ASSIGN       = "assignment"
_STMT_VAR_DECL     = "variable_declaration"
_STMT_EXPR         = "expression_statement"  # not a real node type; handled via fallthrough
_STMT_BREAK        = "break_statement"
_STMT_CONTINUE     = "continue_statement"

_EXPR_CALL         = "call_expression"
_EXPR_BINARY       = "infix_expression"
_EXPR_UNARY        = "prefix_expression"
_EXPR_FIELD        = "navigation_expression"
_EXPR_INDEX        = "subscript_expression"
_EXPR_IDENT        = "simple_identifier"
_EXPR_INT_LIT      = "integer_literal"
_EXPR_FLOAT_LIT    = "real_literal"
_EXPR_STRING_LIT   = "line_string_literal"
...
_PRIM_TYPES: Dict[str, object] = {
    ...
    "UInt":    lambda: T_NUMBER(32, signed=False),
    ...
    "Character": lambda: T_STRING,
    "Bool":    lambda: T_BOOLEAN,
    "Void":    lambda: T_VOID,
    "Never":   lambda: T_VOID,
    "Any":     lambda: T_ANY,
    "AnyObject": lambda: T_ANY,
}
