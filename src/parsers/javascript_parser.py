"""Parse JavaScript source → unified AST using tree-sitter-javascript."""
...
# ---------------------------------------------------------------------------
try:
    import tree_sitter_javascript as _ts_lang
...
_NODE_IMPORT       = "import_statement"
_NODE_FUNCTION     = "function_declaration"
_NODE_METHOD       = "method_definition"
_NODE_CLASS        = "class_declaration"
_NODE_STRUCT       = "class_declaration"
_NODE_INTERFACE    = "class_declaration"
_NODE_VAR          = "variable_declaration"
_NODE_CONST        = "lexical_declaration"   # let / const

_STMT_RETURN       = "return_statement"
_STMT_IF           = "if_statement"
_STMT_WHILE        = "while_statement"
_STMT_FOR          = "for_statement"
_STMT_FOR_EACH     = "for_of_statement"
_STMT_ASSIGN       = "assignment_expression"
_STMT_VAR_DECL     = "lexical_declaration"
...
_EXPR_FIELD        = "member_expression"
_EXPR_INDEX        = "subscript_expression"
_EXPR_IDENT        = "identifier"
_EXPR_INT_LIT      = "number"
_EXPR_FLOAT_LIT    = "number"
_EXPR_STRING_LIT   = "string"
...
_PRIM_TYPES: Dict[str, object] = {
    "number":    lambda: T_NUMBER(64, signed=True, float=True),
