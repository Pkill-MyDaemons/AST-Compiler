"""Parse Java source → unified AST using tree-sitter-java."""
...
# ---------------------------------------------------------------------------
try:
    import tree_sitter_java as _ts_lang
...
_NODE_FUNCTION     = "method_declaration"    # Java top-level methods live inside classes
_NODE_METHOD       = "method_declaration"
_NODE_CLASS        = "class_declaration"
_NODE_STRUCT       = "record_declaration"
_NODE_INTERFACE    = "interface_declaration"
_NODE_VAR          = "field_declaration"
_NODE_CONST        = "field_declaration"

_STMT_RETURN       = "return_statement"
_STMT_IF           = "if_statement"
_STMT_WHILE        = "while_statement"
_STMT_FOR          = "for_statement"
_STMT_FOR_EACH     = "enhanced_for_statement"
_STMT_ASSIGN       = "assignment_expression"
_STMT_VAR_DECL     = "local_variable_declaration"
_STMT_EXPR         = "expression_statement"
_STMT_BREAK        = "break_statement"
_STMT_CONTINUE     = "continue_statement"

_EXPR_CALL         = "method_invocation"
_EXPR_BINARY       = "binary_expression"
_EXPR_UNARY        = "unary_expression"
_EXPR_FIELD        = "field_access"
_EXPR_INDEX        = "array_access"
_EXPR_IDENT        = "identifier"
_EXPR_INT_LIT      = "decimal_integer_literal"
_EXPR_FLOAT_LIT    = "decimal_floating_point_literal"
_EXPR_STRING_LIT   = "string_literal"
_EXPR_BOOL_TRUE    = "true"
_EXPR_BOOL_FALSE   = "false"
_EXPR_NULL         = "null_literal"
...
_PRIM_TYPES: Dict[str, object] = {
    ...
    "byte":    lambda: T_NUMBER(8, signed=True),
    ...
    "void":    lambda: T_VOID,
    "Object":  lambda: T_ANY,
    "Integer": lambda: T_NUMBER(32, signed=True),
    "Long":    lambda: T_NUMBER(64, signed=True),
    "Double":  lambda: T_NUMBER(64, signed=True, float=True),
    "Boolean": lambda: T_BOOLEAN,
}
...
def _parse_top(node: "Node", source: str) -> "Optional[ASTNode | List[ASTNode]]":
    ...
    if t in ("annotation_type_declaration",):
        return _parse_typedef(node, source, TypeDefCategory.INTERFACE)
    if t in ("package_declaration", "module_declaration"):
        return None   # skip — not a node we track
    return None
